package com.cme.oscar.reports.utils;


import com.cme.oscar.reports.beans.APIError;
import com.cme.oscar.reports.constants.StatusConstants;
...
public class ResponseUtils {
	...
	public static ErrorResponse construct400ErrorResponse(List<FieldError> allErrors){
	...
	public static ErrorResponse construct4xxErrorResponse(ErrorConstants errorConstants){

		ErrorResponse errorResponse = new ErrorResponse();

		errorResponse.setCode(errorConstants.getErrorCode());
		errorResponse.setMessage(errorConstants.getDescription());
	...
	public static ErrorResponse construct500ErrorResponse(ErrorConstants errorConstants){
